 ...
 * Build: http://modernizr.com/download/#-backgroundsize-flexbox-flexboxlegacy-cssanimations-csstransforms-csstransforms3d-csstransitions-touch-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-css_filters-load
 */
...
;window.ieTest=function(){
	...
	document.documentElement.className += (rv > 0) ? ' legacy' : ' no-legacy';
}();

;window.scrollTopTest=function(){
	document.documentElement.className += ' scroll-top';
}();
